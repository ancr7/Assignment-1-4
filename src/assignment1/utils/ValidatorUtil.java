...
public class ValidatorUtil {
  ...
  public static void isValidFormat(final String inputString) throws InvalidException {
  ...
  public static void isInputValid(final String name, final String quantity, final String price,
    ...
    switch (type) {
      ...
      case Constant.MANUFACTURED:
        break;
      default:
        throw new InvalidInputException(Constant.INVALID + Constant.SPACE + Constant.TYPE);
    }
  }
}
